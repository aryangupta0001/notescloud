    ...
    return (
        <div className="w-50 m-auto">
            ...
            <div className='container my-5 m-auto' >
                <form onSubmit={handleOnSubmit} className='py-5 m-auto' style={{ width: "50%", boxShadow: "0 10px 24px hsla(0,0%,0%,0.05), 0 20px 48px hsla(0, 0%, 0%, 0.05), 0 1px 4px hsla(0, 0%, 0%, 0.1)" }}>
                    ...
                    <button type="submit" className="btn btn-primary m-auto d-block mt-5" style={{ width: "83%" }}>Change Password</button>
                </form>
            </div >
        </div>
    )
